      ...
      <Container className="py-14">
        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.9fr_1fr]">
          <div>
            ...
            <p className="mt-5 max-w-sm text-[0.95rem] leading-7 text-white/72">
              İhtiyaç sahiplerine umut, güven ve destek ulaştırmak için bağışçı, gönüllü ve saha ekiplerimizle birlikte çalışıyoruz.
            </p>
            <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4 text-[0.95rem] leading-6 text-white/72">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-[0.95rem] text-white/74">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4 text-[0.95rem] text-white/74">
