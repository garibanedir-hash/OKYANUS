  ...
  return (
    <div className="grid gap-6">
      ...
      <AdminFilterBar>
        ...
        <label className="text-sm font-bold text-dark-navy">Ödeme durumu<select className="focus-ring mt-2 w-full rounded-2xl border border-border-soft px-4 py-2"><option>Tümü</option><option>Ödendi</option><option>Beklemede</option><option>Başarısız</option></select></label>
        <label className="text-sm font-bold text-dark-navy">Makbuz durumu<select className="focus-ring mt-2 w-full rounded-2xl border border-border-soft px-4 py-2"><option>Tümü</option><option>Oluşturuldu</option><option>Bekliyor</option><option>Gerekli değil</option></select></label>
