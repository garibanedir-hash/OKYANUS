...
export default function AdminMeetingManagementPage() {
  return (
    <div className="grid gap-5">
      <AdminSectionHeader eyebrow="Toplantı ve Rezervasyon" title="Toplantı Yönetimi" description="Toplantı gündemi, birim ve durum bilgilerini takip etmek için demo ekran." actionLabel="Toplantı Oluştur" />
