      ...
      <section className="bg-white py-16 sm:py-20">
        <Container>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-4">
            {homeFlow.map(({ icon: Icon, title, text }) => (
              <article key={title} className="rounded-brand border border-slate-200 bg-soft-gray p-6">
                <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-deep-blue shadow-sm">
        ...
        <Container>
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <SectionHeading
              ...
              description="Her proje, hedef ve ulaşılan destek bilgisini gösterecek şekilde hazırlandı. İleride gerçek bağış ve raporlama altyapısına bağlanabilir."
            />
          </div>
