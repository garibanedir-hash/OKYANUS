...
-- 001 Core schema migration-ready draft
-- Staging ortamında test edilmeden production'da çalıştırılmamalıdır.
-- Destructive komut içermez; tekrar çalıştırma senaryoları için IF NOT EXISTS / DO blokları kullanılır.

do $$ begin
  create type app_role as enum ('super_admin', 'content_editor', 'donation_manager', 'volunteer_coordinator', 'reporting_manager');
