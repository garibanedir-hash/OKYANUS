...
console.log("Anon write negative test: bu smoke test insert/update/delete yapmaz; staging guard'lı harness için npm run test:security:negative ve docs/form-spam-protection.md kullanılmalıdır.");
