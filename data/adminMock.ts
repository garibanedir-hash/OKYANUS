...
export const mockDonations: MockDonation[] = demoOnly([
  {
    id: "don-1001",
...
export const mockVolunteerApplications: MockVolunteerApplication[] = demoOnly([
  {
    id: "vol-2001",
...
export const mockContactMessages: MockContactMessage[] = demoOnly([
  {
    id: "msg-3001",
...
export const mockStaffMembers: MockStaffMember[] = demoOnly([
...
export const mockTasks: MockTask[] = demoOnly([
...
export const mockConversations: MockConversation[] = demoOnly([
...
export const mockMessages: MockInternalMessage[] = demoOnly([
...
export const mockTaskComments: MockTaskComment[] = demoOnly([
